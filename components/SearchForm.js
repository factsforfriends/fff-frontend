      ...
      <div className="flex justify-around items-center">
        <form className="w-full max-w-sm">
          <div className="flex items-center border-b border-b-2 border-gray-500 bg-white py-2 mb-4 mt-2 rounded-t-lg">
            <input className="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Wonach suchst du?" value={searchTerm} onChange={onChange}></input>
